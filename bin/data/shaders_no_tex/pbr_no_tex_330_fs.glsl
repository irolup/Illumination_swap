...
vec3 brdf_cook_torrance()
{
  ...
  // valeurs constantes pour simuler les textures
  vec3 texture_sample_diffuse = vec3(1.0); // couleur blanche
  float texture_sample_metallic = 0.5; // moitié métallique
  float texture_sample_roughness = 0.5; // rugosité moyenne
  float texture_sample_occlusion = 1.0; // occlusion complète
